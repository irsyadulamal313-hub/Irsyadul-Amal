...
export const Footer: React.FC<FooterProps> = ({ onNavigate, onOpenAdmin }) => {
  ...
  return (
    <footer className="bg-[#051819] text-[#E0EAEA] pt-12 pb-24 md:pb-12 border-t border-[#004D4F]">
          ...
          <div className="md:col-span-5 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#8CE8E8] font-semibold">
                  {siteSettings.tagline || 'Lembaga Sosial & Kemanusiaan'}
                </p>
              </div>
            </div>

            <p className="text-xs text-[#A0BABA] leading-relaxed max-w-sm">
              ...
              {navItems.map((item) => (
                <li key={item.key}>
                  <button
                    ...
                    className="text-[#A0BABA] hover:text-white hover:underline transition-colors"
                  >
                    {item.label}
                  </button>
                </li>
          ...
          <div className="md:col-span-4 space-y-3 text-xs">
            ...
            <div className="pt-2">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-[#8CE8E8] font-bold hover:text-white transition-colors"
              >
          ...
          <div className="flex items-center gap-4 text-[11px]">
            ...
            {onOpenAdmin && (
              <button
                type="button"
                onClick={onOpenAdmin}
                className="text-[#A0BABA] hover:text-white underline"
              >
                Panel Data Admin
              </button>
            )}
